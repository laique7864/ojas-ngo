...
import { addEvent, addPost } from '../../services/admin.service';
...
export default function KeepMountedModal({ refetch }) {
    ...
    const [description, setDescription] = useState('6416bb61115dc8d869fde3e1')
    ...
    async function getFormData(e) {
        ...
        const data = await addPost(formData).then((res) => {
            setResponse(res)
